...
VALUES  (	'GREAT_PERSON_AVIATOR_SIR_GEORGE_CAYLEY', 'GREAT_PERSON_AVIATOR_SIR_GEORGE_CAYLEY_MODIFIERID_1',			'GREAT_PERSON_ACTION_ATTACHMENT_TARGET_PLAYER'),
		(	'GREAT_PERSON_AVIATOR_SIR_GEORGE_CAYLEY', 'GREAT_PERSON_AVIATOR_SIR_GEORGE_CAYLEY_MODIFIERID_2',			'GREAT_PERSON_ACTION_ATTACHMENT_TARGET_PLAYER'),
		(	'GREAT_PERSON_AVIATOR_SIR_GEORGE_CAYLEY', 'GREAT_PERSON_AVIATOR_SIR_GEORGE_CAYLEY_MODIFIERID_3',			'GREAT_PERSON_ACTION_ATTACHMENT_TARGET_PLAYER'),
		(	'GREAT_PERSON_AVIATOR_SIR_GEORGE_CAYLEY', 'GREAT_PERSON_AVIATOR_SIR_GEORGE_CAYLEY_MODIFIERID_4',			'GREAT_PERSON_ACTION_ATTACHMENT_TARGET_PLAYER');
