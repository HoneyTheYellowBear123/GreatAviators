...
VALUES  ('UNIT_GREAT_AVIATOR', 'KIND_UNIT'),
		...
		('GREAT_PERSON_AVIATOR_AMELIA_EARHART', 'KIND_GREAT_PERSON_INDIVIDUAL'), --$ gain 1500 culture (on standard speed) NOT YET IMPLEMENTED -----> grants sufferage (or extra culture if its already been discovered)
...
VALUES  ('GREAT_PERSON_AVIATOR_SIR_GEORGE_CAYLEY', 'LOC_GREAT_PERSON_AVIATOR_SIR_GEORGE_CAYLEY',    'GREAT_PERSON_CLASS_AVIATOR',    'DUMMY_ERA_GREAT_AVIATORS_2',				'M',    1,            0,				                    0,										0,      			  NULL,									NULL,                                  NULL,                          NULL,										0,							0,                 'LOC_GREAT_PERSON_AVIATOR_SIR_GEORGE_CAYLEY_ACTION'  ), --LOC_GREATPERSON_ACTION_NAME_RETIRE
		...
		('GREAT_PERSON_AVIATOR_RENE_LORIN',		'LOC_GREAT_PERSON_AVIATOR_RENE_LORIN',		'GREAT_PERSON_CLASS_AVIATOR',    'DUMMY_ERA_GREAT_AVIATORS_1',						'M',    1,            1,				                    0,										0,      			  NULL,									NULL,                                  NULL,                          'DISTRICT_AERODROME',						0,							1,                 'LOC_GREAT_PERSON_AVIATOR_RENE_LORIN_ACTION'  ),		
		('GREAT_PERSON_AVIATOR_MANFRED_ALBRECHT_FREIHERR_VON_RICHTHOFEN',		'LOC_GREAT_PERSON_AVIATOR_MANFRED_ALBRECHT_FREIHERR_VON_RICHTHOFEN',		'GREAT_PERSON_CLASS_AVIATOR',    'DUMMY_ERA_GREAT_AVIATORS_2',		'M',    1,       1, 0,								0,      			  NULL,									NULL,                                  NULL,                          'DISTRICT_AERODROME',						0,							1,                 'LOC_GREAT_PERSON_AVIATOR_MANFRED_ALBRECHT_FREIHERR_VON_RICHTHOFEN_ACTION'  ),	
		...
		('GREAT_PERSON_AVIATOR_RADOJE_LJUTOVAC', 'LOC_GREAT_PERSON_AVIATOR_RADOJE_LJUTOVAC',			'GREAT_PERSON_CLASS_AVIATOR', 'DUMMY_ERA_GREAT_AVIATORS_2',				 'M',    1,            1,				                    0,										0,      			  NULL,									NULL,                                  NULL,                          'DISTRICT_AERODROME',						0,							1,                 'LOC_GREAT_PERSON_AVIATOR_RADOJE_LJUTOVAC_ACTION'  ),				
		('GREAT_PERSON_AVIATOR_FLOYD_FOGLEMAN',		'LOC_GREAT_PERSON_AVIATOR_FLOYD_FOGLEMAN',		 'GREAT_PERSON_CLASS_AVIATOR', 'DUMMY_ERA_GREAT_AVIATORS_2',				 'M',    1,            1,				                    0,										0,      			  NULL,									NULL,                                  NULL,                          'DISTRICT_AERODROME',						0,							1,                 'LOC_GREAT_PERSON_AVIATOR_FLOYD_FOGLEMAN_ACTION'  ),	
		('GREAT_PERSON_AVIATOR_CLEMENT_ADER',		'LOC_GREAT_PERSON_AVIATOR_CLEMENT_ADER',		 'GREAT_PERSON_CLASS_AVIATOR', 'DUMMY_ERA_GREAT_AVIATORS_2',				 'M',    1,            1,				                    0,										0,      			  NULL,									NULL,                                  NULL,                          'DISTRICT_AERODROME',						0,							1,                 'LOC_GREAT_PERSON_AVIATOR_CLEMENT_ADER_ACTION'  ),	
		...
		('GREAT_PERSON_AVIATOR_GUSTAV_RASMUS', 'LOC_GREAT_PERSON_AVIATOR_GUSTAV_RASMUS',		 'GREAT_PERSON_CLASS_AVIATOR',		'DUMMY_ERA_GREAT_AVIATORS_2',			     'M',    1,            1,				                    0,										0,      			  NULL,									NULL,                                  NULL,                          'DISTRICT_AERODROME',						0,							1,                 'LOC_GREAT_PERSON_AVIATOR_GUSTAV_RASMUS_ACTION'  ),	
		('GREAT_PERSON_AVIATOR_DOUGLAS_DOUGLAS_HAMILTON', 'LOC_GREAT_PERSON_AVIATOR_DOUGLAS_DOUGLAS_HAMILTON',	 'GREAT_PERSON_CLASS_AVIATOR', 'DUMMY_ERA_GREAT_AVIATORS_2',	 'M',    1,            0,				                    0,										0,      			  NULL,									NULL,                                  NULL,                          NULL,										1,							1,                 'LOC_GREAT_PERSON_AVIATOR_DOUGLAS_DOUGLAS_HAMILTON_ACTION'  ),
