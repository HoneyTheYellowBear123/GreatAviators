...
VALUES  ('GREAT_PERSON_AVIATOR_SIR_GEORGE_CAYLEY', 'LOC_GREAT_PERSON_AVIATOR_SIR_GEORGE_CAYLEY',    'GREAT_PERSON_CLASS_AVIATOR',    'DUMMY_ERA_GREAT_AVIATORS_1',				'M',    1,            0,				                    0,										0,      			  NULL,									NULL,                                  NULL,                          NULL,										0,							0,                 'LOC_GREAT_PERSON_AVIATOR_SIR_GEORGE_CAYLEY_ACTION'  ), --LOC_GREATPERSON_ACTION_NAME_RETIRE
		...
		('GREAT_PERSON_AVIATOR_ALBERTO_SANTOS_DUMONT', 'LOC_GREAT_PERSON_AVIATOR_ALBERTO_SANTOS_DUMONT', 'GREAT_PERSON_CLASS_AVIATOR',		'DUMMY_ERA_GREAT_AVIATORS_3',	     'M',    1,            1,				                    0,										0,      			  NULL,									NULL,                                  NULL,                          'DISTRICT_AERODROME',						0,							1,                 'LOC_GREAT_PERSON_AVIATOR_ALBERTO_SANTOS_DUMONT_ACTION'  ),	
		...
		('GREAT_PERSON_AVIATOR_CHUCK_YEAGER', 'LOC_GREAT_PERSON_AVIATOR_CHUCK_YEAGER',			 'GREAT_PERSON_CLASS_AVIATOR',		'DUMMY_ERA_GREAT_AVIATORS_4',			     'M',    1,            1,				                    0,										0,      			  NULL,									NULL,                                  NULL,                          'DISTRICT_AERODROME',						0,							1,                 'LOC_GREAT_PERSON_AVIATOR_CHUCK_YEAGER_ACTION'  ),	
...
VALUES  (	'GREAT_PERSON_AVIATOR_SIR_GEORGE_CAYLEY', 'GREAT_PERSON_AVIATOR_SIR_GEORGE_CAYLEY_MODIFIERID_1',			'GREAT_PERSON_ACTION_ATTACHMENT_TARGET_UNIT_GREATPERSON'),
		...
		(   'GREAT_PERSON_AVIATOR_ALBERTO_SANTOS_DUMONT', 'GREAT_PERSON_AVIATOR_ALBERTO_SANTOS_DUMONT_MODIFIERID_SCIENCE', 'GREAT_PERSON_ACTION_ATTACHMENT_TARGET_UNIT_GREATPERSON'),
		(   'GREAT_PERSON_AVIATOR_ALBERTO_SANTOS_DUMONT', 'GREAT_PERSON_AVIATOR_ALBERTO_SANTOS_DUMONT_MODIFIERID_CULTURE', 'GREAT_PERSON_ACTION_ATTACHMENT_TARGET_UNIT_GREATPERSON'),
...
VALUES  ( 'GREAT_PERSON_AVIATOR_SIR_GEORGE_CAYLEY_MODIFIERID_1', 'MODIFIER_PLAYER_GRANT_SPECIFIC_TECH_BOOST',       1,        1,          NULL    ),
		...
		( 'GREAT_PERSON_AVIATOR_ALBERTO_SANTOS_DUMONT_MODIFIERID_SCIENCE',	 'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER',							  1,        1,          'PLAYER_IS_AT_PEACE_WITH_ALL_MAJORS'     ),
		( 'GREAT_PERSON_AVIATOR_ALBERTO_SANTOS_DUMONT_MODIFIERID_CULTURE',	 'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER',							  1,        1,          'PLAYER_IS_AT_PEACE_WITH_ALL_MAJORS'    ),
...
VALUES  ('GREAT_PERSON_AVIATOR_SIR_GEORGE_CAYLEY_MODIFIERID_1',  'TechType', 'TECH_FLIGHT'),
		...
		('GREAT_PERSON_AVIATOR_ALBERTO_SANTOS_DUMONT_MODIFIERID_SCIENCE',  'YieldType', 'YIELD_SCIENCE'),
		('GREAT_PERSON_AVIATOR_ALBERTO_SANTOS_DUMONT_MODIFIERID_SCIENCE',  'Amount', 5),
		('GREAT_PERSON_AVIATOR_ALBERTO_SANTOS_DUMONT_MODIFIERID_CULTURE',  'YieldType', 'YIELD_CULTURE'),
		('GREAT_PERSON_AVIATOR_ALBERTO_SANTOS_DUMONT_MODIFIERID_CULTURE',  'Amount', 5),
